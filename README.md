...
[![x-cmd/install — cloudlist Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/cloudlist.svg)](https://x-cmd.com/install/cloudlist)
...
- **Upstream**: <https://github.com/projectdiscovery/cloudlist>
...
- **Stars**: 1,054 · **Forks**: 132 · **Open issues**: 77 · **Contributors**: 39

## Totals (cumulative)

- **Releases**: 17 · **Merged PRs**: 439 · **Open PRs**: 3 · **Closed issues**: 76 · **Open issues**: 1 · **Commits**: 919
...
_Snapshot: `data/card/260925.yml` · 2026-09-25T05:29:02Z._
